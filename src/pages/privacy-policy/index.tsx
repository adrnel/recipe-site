  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <section>
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              ...
              is used and to improve its content and functionality.
            </li>
          </ul>
        </section>
        <section>
          ...
          <p>
            ...
            third parties only in the following situations:
          </p>
          <ul className="list-disc list-inside">
            <li>
        ...
        <section>
          <h2 className="text-3xl font-bold mt-4 mb-4">Third-Party Websites</h2>
          <p>
