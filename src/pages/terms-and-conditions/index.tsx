  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-4xl font-bold my-6 mb-12">Terms and Conditions</h1>
        <section>
        ...
        <section>
          <h2 className="text-3xl font-bold mt-4 mb-4">User Comments</h2>
          <p>
        ...
        <section>
          <h2 className="text-3xl font-bold mt-4 mb-4">iFrames</h2>
          <p>
        ...
        <section>
          <h2 className="text-3xl font-bold mt-4 mb-4">Content Liability</h2>
          <p>
        ...
        <section>
          <h2 className="text-3xl font-bold mt-4 mb-4">Your Privacy</h2>
        ...
        <section>
          <h2 className="text-3xl font-bold mt-4 mb-4">Disclaimer</h2>
          <p>
